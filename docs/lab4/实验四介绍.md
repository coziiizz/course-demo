...
### [任务一：词嵌入](./词嵌入.md)
[下载任务一代码](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab4/embedding_main.ipynb){ .md-button}
...
- 词嵌入的基本原理
- 探索词嵌入及其基本性质
- 使用PyTorch框架实现带 mask 的均值池化与最大池化融合文本分类
- 模型训练与评估
- 思考题讨论
...
[下载任务二代码](https://cdn.jsdelivr.net/gh/zhiweinju/nju-dl-lab-2026spring@main/docs/lab4/RNN_main.ipynb){ .md-button}
...
- 文本预处理与低频词过滤
- RNN文本生成实验（含 top-k 采样）
- LSTM和GRU文本生成实验（含梯度裁剪与 top-k 采样）
- RNN、LSTM和GRU的比较思考
...
1. 本次提交的内容为: 实验四要求提交的内容，具体要求请参见实验网站（https://zhiweinju.github.io/nju-dl-lab-2026spring/）
